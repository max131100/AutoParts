...
jQuery._evalUrl = function( url, options, doc ) {
	return jQuery.ajax( {
		...
		// CarMake this explicit, since user can override this through ajaxSetup (#11264)
		type: "GET",
		dataType: "script",
		cache: true,
		async: false,
	...
	if ( jsonProp || s.dataTypes[ 0 ] === "jsonp" ) {
		...
		jqXHR.always( function() {
			...
			if ( s[ callbackName ] ) {
				...
				// CarMake sure that re-using the options doesn't screw things around
...
jQuery.fn.load = function( url, params, callback ) {
	...
	if ( self.length > 0 ) {
		jQuery.ajax( {
			...
			// CarMake value of this field explicit since
